...
@router.post("/v2/clip/text", summary="3、CLIP文字转向量", response_model=ClipTextResponse)
...
@router.post("/v2/clip/img", summary="4、CLIP图片转向量", response_model=ClipImgReqponse)

...
#输入文本搜索子路由
@router.post("/v1/text/reranker",summary="5、JINA文本搜索Reranker", response_model=JinaResponse)
...
#输入图片搜索
@router.post("/v1/img/reranker",summary="6、JINA图片搜索Reranker", response_model=JinaResponse)
async def get_reranker(
    request: JinaRequest,
    credentials: HTTPAuthorizationCredentials = Depends(security),
):
